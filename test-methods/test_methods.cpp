...
void test34(Method method) {
    auto start_points = gen_start_points(2, -3, 4);
    auto expected = std::vector<ControlPoint>{
        {{-2.8051, 3.1313}, "Global Min"}
    };
    fout_txt << "----------------------------------- Тест 34 ----------------------------------\n\n";
...
void test35(Method method) {
    auto expected = std::vector<ControlPoint>{
        {{-0.07428, 18.8172}, "Global Min"}
    };
    auto start_points = gen_start_points(2, -5, 20);
    fout_txt << "----------------------------------- Тест 35 -----------------------------------\n\n";
...
void test36(Method method) {
    auto expected = std::vector<ControlPoint>{{{0, -2.4945}, "Global Min"}};
...
void test52(Method method) {
	auto expected = std::vector<ControlPoint>{ {{0, 0.575}, "Global Min"} };
...
void test56(Method method) {
    auto expected = std::vector<ControlPoint>{{{0, 0.0046}, "Global Min"},{{2, 4}, "Local Min"},{{1.464, -2.506}, "Local Min"}};
...
void test57(Method method) {
    auto expected = std::vector<ControlPoint>{{{-2.8051, 3.1313}, "Global Min"},  {{-1.74755, 0.873776}, " Local Min"},
            {{1.74755, -0.873776}, " Local Min"}};
    auto start_points = gen_start_points(2, -1, 1);
    fout_txt << "----------------------------------- Тест 57 -----------------------------------\n\n";
...
void test58(Method method) {
    ...
    auto start_points = gen_start_points(2, -5, 5);
    fout_txt << "----------------------------------- Тест 58 ----------------------------------\n\n";
    fout_txt << "58. Гладкая функция:\n\tf(x1, ..., xn) = информация на данный момент недоступна, имеющая один глобальный минимум. \nПодробнее в документе \"Тестовые функции\"\n\n";
    fout_txt << "Условие остановы: iter_counter >= 100 || |f_i-f_(i-1)| < 0.00000001\n\n";
